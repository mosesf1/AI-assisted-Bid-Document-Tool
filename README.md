...
3. Press run on the python file, it will prompt you to select the pdf you would like to summarize and extract, select the PDF. If you do not have the PDF, download the file from this Repository. 
...
5. Finally you have all the files needed, to reuse for a different PDF just run the program and when prompted select a different contract bid. An example of output using the input provided are both in this repository. 
